...
$(function() {
  ...
  function loadSwaggerUi(config) {
    ...
    window.swaggerUi.api.clientAuthorizations.add("source", new SwaggerClient.ApiKeyAuthorization("source", "explorer", "header"));
    window.swaggerUi.api.clientAuthorizations.add("version", new SwaggerClient.ApiKeyAuthorization("version", "1.0.0", "header"));
  }
